...
export default function Sidebar() {
    ...
    return (
        <div className="h-screen bg-[#111B3C] flex flex-col p-3 md:p-4 border-r border-[#2a3e7b]">
                ...
                {menuItems.map((item) => {
                    ...
                    return (
                        <Link key={item.name} href={item.path} className="block">
                            <div
                                className={`
                  flex items-center gap-3 p-2 md:px-4 md:py-2 rounded-lg transition-all
                ...
                `}
                        ...
                        `,
                            ...
                            >
                                ...
                                {/* Label only on md and above */}
                                <span className="hidden md:block text-white text-sm">{item.name}</span>
                            </div>
                        </Link>
                    );
                })}
